...
namespace PCAxis.Api.VisitorStatistics
{
    static class VisitorStatisticsApiHelper
    {
        private static IApilogger _logger;
        private static log4net.ILog _log4net = log4net.LogManager.GetLogger(typeof(VisitorStatisticsApiHelper));
