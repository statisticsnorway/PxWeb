...
namespace PXWeb
{
    public partial class Chart : System.Web.UI.Page
    {
        ...
        private static readonly log4net.ILog _logger = log4net.LogManager.GetLogger(typeof(Chart));
